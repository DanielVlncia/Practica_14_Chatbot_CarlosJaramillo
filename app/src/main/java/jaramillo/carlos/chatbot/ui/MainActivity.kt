...
import jaramillo.carlos.chatbot.utils.BotResponse
import jaramillo.carlos.chatbot.utils.Constans
import jaramillo.carlos.chatbot.utils.Time
...
class MainActivity : AppCompatActivity() {
    ...
    private val botList = listOf("Peter","Francesca","Daniel","Luigi","Igor")
